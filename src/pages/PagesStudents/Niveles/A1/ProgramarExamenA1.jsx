...
function ProgramarExamenA1() {
    ...
    async function listExamenesDisponibles() {
        try {
            const respuestaExamenesDisponibles = await fetchBody('/niveles/listarExamen', 'POST', { nivel: "A1" });
            if (respuestaExamenesDisponibles.exito) {
                ...
                if (token) {
                    ...
                    const respuestaExamenesProgramados = await fetchBody('/estudiantes/actualizarExamenesDisponibles', 'POST', { id: idEst, nivel: 'A1' });
        ...
        try {
            ...
            if (respuesta.exito) {
                ...
                if (token) {
                    ...
                    const respuestaHorasAgendadas = await fetchBody('/estudiantes/obtenerHorasAgendadasExamen', 'POST', { idEstudiante: idEst, nivel: 'A1' });
