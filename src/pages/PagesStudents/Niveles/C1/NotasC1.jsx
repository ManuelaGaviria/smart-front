    ...
    async function listNotas() {
        ...
        if (token) {
            ...
            try {
                ...
                const respuesta = await fetchBody('/estudiantes/listarNotasExamen', 'POST', { idEstudiante: idEstudiante, nivel: "C1" })
                if (respuesta.exito) {
    ...
    return (
        <motion.div
            ...
            <FullscreenCard>
                                    ...
                                    <tr key={nota.examenId}>
                                        ...
                                        <td>
                                            <button
                                                className='btn-color'
                                                onClick={() =>
                                                    handleSolicitud(nota.examenId, "C1", nota.promedio, nota.notaExamenEscrito, nota.notaExamenOral)
                                                }
                                            >
                                                Solicitar
                                            </button>
                                            <button
                                                className='btn-eye'
                                                onClick={() =>
                                                    handleVerSolicitud(nota.examenId, "C1")
                                                }
                                            >
                                                <FaEye />
                                            </button>
                ...
                <ButtonLink destino="/C1" clase="ButtonRegresar">Regresar</ButtonLink>
            </FullscreenCard>
        </motion.div>
    )
}

export default NotasC1