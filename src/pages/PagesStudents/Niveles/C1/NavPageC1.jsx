  ...
  const finalizarExamenTimer = async () => {
    ...
    try {
      ...
      if (respuesta.exito) {
        ...
        navigate('/ExamenEscritoC1'); // ✅ Redirigir a la página de inicio solo si la respuesta es exitosa
      } else {
  ...
  useEffect(() => {
    ...
    const obtenerPreguntas = async () => {
      ...
      try {
        ...
        const respuesta = await fetchBody('/estudiantes/getPreguntasExamen', 'POST', { nivel: "C1", examenId: examenId });
        if (respuesta.exito) {
