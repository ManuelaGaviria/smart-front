...
function ProgramarExamenB2() {
    ...
    useEffect(() => {
        const obtenerExamenes = async () => {
            try {
                const respuesta = await fetchBody('/niveles/obtenerExamen', 'POST', { nivel: "B2" });
                if (respuesta.exito) {
    ...
    async function listExamenesDisponibles() {
        try {
            const respuestaExamenesDisponibles = await fetchBody('/niveles/listarExamen', 'POST', { nivel: "B2" });
            if (respuestaExamenesDisponibles.exito) {
                ...
                if (token) {
                    ...
                    const respuestaExamenesProgramados = await fetchBody('/estudiantes/actualizarExamenesDisponibles', 'POST', { id: idEst, nivel: 'B2' });
        ...
        try {
            ...
            if (respuesta.exito) {
                ...
                if (token) {
                    ...
                    const respuestaHorasAgendadas = await fetchBody('/estudiantes/obtenerHorasAgendadasExamen', 'POST', { idEstudiante: idEst, nivel: 'B2' });
