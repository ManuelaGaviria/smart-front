    ...
    transition={{ duration: 2 }}>
      ...
      > 
        <div className='ButtonsAdminContainer'>
          <h1>Nivel B2</h1>
          <div className=''>
            <ButtonLink destino="/ProgramarB2" clase="Button2">Programar</ButtonLink>
            <ButtonLink destino="/ExamenEscritoB2" clase="Button2">Realizar examen</ButtonLink>
            <ButtonLink destino="/NotasB2" clase="Button2">Ver notas</ButtonLink>
