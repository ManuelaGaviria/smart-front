    ...
    transition={{ duration: 2 }}>
      ...
      > 
        <div className='ButtonsAdminContainer'>
          <h1>Nivel A2</h1>
          <div className=''>
            <ButtonLink destino="/ProgramarA2" clase="Button2">Programar</ButtonLink>
            <ButtonLink destino="/ExamenEscritoA2" clase="Button2">Realizar examen</ButtonLink>
            <ButtonLink destino="/NotasA2" clase="Button2">Ver notas</ButtonLink>
