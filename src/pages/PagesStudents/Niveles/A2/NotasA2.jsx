    ...
    async function listNotas() {
        ...
        if (token) {
            ...
            try {
                ...
                const respuesta = await fetchBody('/estudiantes/listarNotasExamen', 'POST', { idEstudiante: idEstudiante, nivel: "A2" })
                if (respuesta.exito) {
    ...
    return (
        <motion.div
            ...
            <FullscreenCard>
                                    ...
                                    <tr key={nota.examenId}>
                                        ...
                                        <td>
                                            <button
                                                className='btn-color'
                                                onClick={() =>
                                                    handleSolicitud(nota.examenId, "A2", nota.promedio, nota.notaExamenEscrito, nota.notaExamenOral)
                                                }
                                            >
                                                Solicitar
                                            </button>
                                            <button
                                                className='btn-eye'
                                                onClick={() =>
                                                    handleVerSolicitud(nota.examenId, "A2")
                                                }
                                            >
                                                <FaEye />
                                            </button>
                ...
                <ButtonLink destino="/A2" clase="ButtonRegresar">Regresar</ButtonLink>
            </FullscreenCard>
        </motion.div>
    )
}

export default NotasA2