...
function ProgramarExamenB1() {
    ...
    useEffect(() => {
        const obtenerExamenes = async () => {
            try {
                const respuesta = await fetchBody('/niveles/obtenerExamen', 'POST', { nivel: "B1" });
                if (respuesta.exito) {
    ...
    async function listExamenes() {
        try {
            ...
            if (token) {
                ...
                const respuestaExamenes = await fetchBody('/niveles/listarExamen', 'POST', { nivel: 'B1' });
                // Obtener el estado de los examenes programados
                const respuestaEstado = await fetchBody('/estudiantes/actualizarEstadoExamen', 'POST', { idEstudiante: idEst, nivel: 'B1' });
    ...
    async function listExamenesProgramados() {
        try {
            ...
            if (token) {
                ...
                const respuesta = await fetchBody('/estudiantes/listarExamenProgramado', 'POST', { idEstudiante: idEst, nivel: 'B1' });
    ...
    async function listExamenesDisponibles() {
        try {
            const respuestaExamenesDisponibles = await fetchBody('/niveles/listarExamen', 'POST', { nivel: "B1" });
            if (respuestaExamenesDisponibles.exito) {
                ...
                if (token) {
                    ...
                    const respuestaExamenesProgramados = await fetchBody('/estudiantes/actualizarExamenesDisponibles', 'POST', { id: idEst, nivel: 'B1' });
        ...
        try {
            ...
            if (respuesta.exito) {
                ...
                if (token) {
                    ...
                    const respuestaHorasAgendadas = await fetchBody('/estudiantes/obtenerHorasAgendadasExamen', 'POST', { idEstudiante: idEst, nivel: 'B1' });
        ...
        if (respuesta.exito) {
           ...
           // listExamenesDisponibles();
            ...
            Swal.fire({
                icon: "error",
                title: "Error",
                text: `Error al programar el examen: ${respuesta.reason}`,
                customClass: {
                    confirmButton: 'btn-color'
                },
                buttonsStyling: false
        ...
        <motion.div
            ...
            <FullscreenCard>
                <div>
                    ...
                    <ButtonLink destino="/HorarioExamenB1" clase="ButtonRegresar">Ver Horario</ButtonLink>
                </div>
                <br></br>
                ...
                <ButtonLink destino="/ProgramarB1" clase="ButtonRegresar">Regresar</ButtonLink>
            </FullscreenCard>
...
export default ProgramarExamenB1