  ...
  const finalizarExamenTimer = async () => {
    ...
    try {
      ...
      if (respuesta.exito) {
        ...
        navigate('/ExamenEscritoB1'); // ✅ Redirigir a la página de inicio solo si la respuesta es exitosa
      } else {
  ...
  useEffect(() => {
    ...
    const obtenerPreguntas = async () => {
      ...
      try {
        ...
        const respuesta = await fetchBody('/estudiantes/getPreguntasExamen', 'POST', { nivel: "B1", examenId: examenId });
        if (respuesta.exito) {
