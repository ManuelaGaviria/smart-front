    ...
    async function listNotas() {
        ...
        if (token) {
            ...
            try {
                ...
                const respuesta = await fetchBody('/estudiantes/listarNotasExamen', 'POST', { idEstudiante: idEstudiante, nivel: "B1" })
                if (respuesta.exito) {
    ...
    return (
        <motion.div
            ...
            <FullscreenCard>
                                    ...
                                    <tr key={nota.examenId}>
                                        ...
                                        <td>
                                            <button
                                                className='btn-color'
                                                onClick={() =>
                                                    handleSolicitud(nota.examenId, "B1", nota.promedio, nota.notaExamenEscrito, nota.notaExamenOral)
                                                }
                                            >
                                                Solicitar
                                            </button>
                                            <button
                                                className='btn-eye'
                                                onClick={() =>
                                                    handleVerSolicitud(nota.examenId, "B1")
                                                }
                                            >
                                                <FaEye />
                                            </button>
                ...
                <ButtonLink destino="/B1" clase="ButtonRegresar">Regresar</ButtonLink>
            </FullscreenCard>
        </motion.div>
    )
}

export default NotasB1