...
function VerClaseB2() {
  ...
  async function listClases() {
    try {
      const respuesta = await fetchBody('/niveles/listarClase', 'POST', { nivel: "B2" });
      if (respuesta.exito) {
  ...
  return (
    <motion.div
      ...
      <FullscreenCard>
        ...
        <ButtonLink destino="/GestionarB2" clase="ButtonRegresar">Regresar</ButtonLink>
      </FullscreenCard>
