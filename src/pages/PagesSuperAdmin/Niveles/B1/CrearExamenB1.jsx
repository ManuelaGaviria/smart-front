  ...
  return (
    <motion.div className="login-container"
      ...
      <ContenedorForms>
        ...
        <ButtonLink destino="/GestionarExamenB1" clase="Button">Regresar</ButtonLink>
      </ContenedorForms>
    </motion.div>
  );
}

export default CrearExamenB1;
