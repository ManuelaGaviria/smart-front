...
function VerClaseB1() {
  ...
  async function listClases() {
    try {
      const respuesta = await fetchBody('/niveles/listarClase', 'POST', { nivel: "B1" });
      if (respuesta.exito) {
  ...
  return (
    <motion.div
      ...
      <FullscreenCard>
        ...
        <ButtonLink destino="/GestionarB1" clase="ButtonRegresar">Regresar</ButtonLink>
      </FullscreenCard>
