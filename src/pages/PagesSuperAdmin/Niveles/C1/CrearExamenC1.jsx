  ...
  return (
    <motion.div className="login-container"
      ...
      <ContenedorForms>
        ...
        <ButtonLink destino="/GestionarExamenC1" clase="Button">Regresar</ButtonLink>
      </ContenedorForms>
    </motion.div>
  );
}

export default CrearExamenC1;
