...
function VerClaseC1() {
  ...
  async function listClases() {
    try {
      const respuesta = await fetchBody('/niveles/listarClase', 'POST', { nivel: "C1" });
      if (respuesta.exito) {
  ...
  return (
    <motion.div
      ...
      <FullscreenCard>
        ...
        <ButtonLink destino="/GestionarC1" clase="ButtonRegresar">Regresar</ButtonLink>
      </FullscreenCard>
