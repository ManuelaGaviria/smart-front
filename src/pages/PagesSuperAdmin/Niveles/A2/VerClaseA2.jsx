...
function VerClaseA2() {
  ...
  async function listClases() {
    try {
      const respuesta = await fetchBody('/niveles/listarClase', 'POST', { nivel: "A2" });
      if (respuesta.exito) {
  ...
  return (
    <motion.div
      ...
      <FullscreenCard>
        ...
        <ButtonLink destino="/GestionarA2" clase="ButtonRegresar">Regresar</ButtonLink>
      </FullscreenCard>
