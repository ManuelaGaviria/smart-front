  ...
  return (
    <motion.div className="login-container"
      ...
      <ContenedorForms>
        ...
        <ButtonLink destino="/GestionarExamenA2" clase="Button">Regresar</ButtonLink>
      </ContenedorForms>
    </motion.div>
  );
}

export default CrearExamenA2;
