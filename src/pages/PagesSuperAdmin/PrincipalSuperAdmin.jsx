    ...
    transition={{ duration: 2 }}>
      ...
      > 
        <div className='ButtonsAdminContainer'>
          ...
          <div className=''>
            <ImageButton icon={FaChalkboardTeacher} texto="Gestionar Administradores" destino="/PrincipalTeacher"></ImageButton>
            <ImageButton icon={PiStudentBold} texto="Gestionar Niveles" destino="/PrincipalStudent"></ImageButton>
          </div>
        </div> 
      </motion.div>
    </motion.div>
